...
export default function Gre() {
    ...
    const navigate = useNavigate();
        ...
        const course = useMemo(() => (
            ...
            courseCatalog.find((item) => item.id === 'gre') ||
            null
        ), [selectedCourseKey]);
        ...
        const buildEnrollmentSelection = (tabKey) => {
            ...
            return {
                courseId: course?.id || 'gre', programName: 'GRE', tab: tabKey, country: geoCountry,
        ...
        return (
            <main>
                <section className="course-detail">
                    <div className="course-detail-tabs" role="tablist" aria-label="GRE programs">
                        <button type="button" className={`course-detail-tab ${activeTab === 'online' ? 'is-active' : ''}`} role="tab" id="gre-online-tab" aria-selected={activeTab === 'online'} aria-controls="gre-online-panel" onClick={() => setActiveTab('online')}>Online</button>
                        <button type="button" className={`course-detail-tab ${activeTab === 'selfLearning' ? 'is-active' : ''}`} role="tab" id="gre-self-learning-tab" aria-selected={activeTab === 'selfLearning'} aria-controls="gre-self-learning-panel" onClick={() => setActiveTab('selfLearning')}>Self Learning</button>
                        <button type="button" className={`course-detail-tab ${activeTab === 'materials' ? 'is-active' : ''}`} role="tab" id="gre-materials-tab" aria-selected={activeTab === 'materials'} aria-controls="gre-materials-panel" onClick={() => setActiveTab('materials')}>Materials</button>
                    ...
                    <div className="course-detail-grid">
                        ...
                        <div className="course-detail-content">
                            <div role="tabpanel" id="gre-online-panel" aria-labelledby="gre-online-tab" hidden={activeTab !== 'online'}>{renderTabContent('online', 'OL')}</div>
                            <div role="tabpanel" id="gre-self-learning-panel" aria-labelledby="gre-self-learning-tab" hidden={activeTab !== 'selfLearning'}>{renderTabContent('selfLearning', 'SL')}</div>
                            <div role="tabpanel" id="gre-materials-panel" aria-labelledby="gre-materials-tab" hidden={activeTab !== 'materials'}>{renderPracticeMaterial()}</div>
                        </div>
                    </div>
                </section>
            </main>
